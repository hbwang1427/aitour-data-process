...
if __name__ == '__main__':
	...
	for  artist_id in range(0,2996):
		...
		try:
			...
			print("art_detail json not exit")
			#print(art_detail)
		...
		try:
			...
			print(e)
			print("image feature index not exist")
		...
		try:
			...
			cur.execute("insert into ai_reference_image(image_id,art_id,image_location,image_feature,mobilenet_feature) values(%s,%s,%s,%s,%s)",(art_id,art_id,art_id_str,art_features[art_id_str],mobilenet_features[art_id_str]))
			conn.commit()
		except Exception,e1:
			print(e1)
