...
if __name__ == '__main__':
     ...
     MET_URL_TEMPLATE='https://www.metmuseum.org/api/collection/collectionlisting?perPage=20&sortBy=Relevance&sortOrder=asc&offset=%d&pageSize=0'
     SUFFIX=''
     ...
     #search_list = ['/art/collection/search/205485', '/art/collection/search/206045', '/art/collection/search/544498', '/art/collection/search/489701']
     search_list = ['/art/collection/search/205485']

     #for offset in range(200,4000,20):
...
#        url = MET_URL_TEMPLATE % (offset) + SUFFIX
     ...
     #       print (response)
       ...
       # print (result)
        #sleep for random seconds in range [1, 2]
        time.sleep(random.randint(1, 2))
